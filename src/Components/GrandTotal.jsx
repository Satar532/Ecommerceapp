    ...
    <div style={{display:"Flex",justifyContent:"center",paddingRight:"3em",fontWeight:"normal",fontFamily:"revert-layer",flexDirection:"column",alignItems:"center",marginTop:"1em ",flexWrap:"wrap"}}>
        ...
        <form style={{display:"flex",flexDirection:"column",rowGap:"0.7em"}}>
         <label htmlFor="name"> Name</label>
          ...
          <button style={{padding:"9px",backgroundColor:"green",border:"none",color:"white",fontSize:"17px"}} onClick={()=>dispatch(AddtoDB({name:"sattar",id:Date.now(),qty:3,prie:4500,disount:200,orderDate:Date.now().toLocaleString()}))} > Proceed Now</button>

        </form>
      <div className="price">
         <h4> Total Product {Cartproduct?.length} </h4>
         <p>Discount 50 :</p>
