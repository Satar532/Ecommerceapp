...
<Link to="/cart"><i className='fas fa-cart-plus' style={{fontSize:"28px",color:"red"}}  ><button type="button" className="btn  position-relative">
  ...
  {!Islogined ?  <> <button   style={{padding:"8px 20px",height:"39px",backgroundColor:"#E11D48",border:"none",color:"white",fontSize:"17px",boxShadow:"0.1px 0.1px 0.1px 0.1px gray",borderRadius:"3px"}}> <Link to="/signup" style={{textDecoration:"none",color:"white"}}>  Sign Up</Link></button>
